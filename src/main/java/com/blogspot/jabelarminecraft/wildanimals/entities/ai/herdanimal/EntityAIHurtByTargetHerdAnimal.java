...
public class EntityAIHurtByTargetHerdAnimal extends EntityAITarget
{
	...
	public void startExecuting()
    {
        ...
        if (entityCallsForHelp)
        {
            ...
            List list = taskOwnerHerdAnimal.worldObj.getEntitiesWithinAABB(taskOwnerHerdAnimal.getClass(), AxisAlignedBB.getAABBPool().getAABB(taskOwner.posX, taskOwner.posY, taskOwner.posZ, taskOwner.posX + 1.0D, taskOwner.posY + 1.0D, taskOwner.posZ + 1.0D).expand(d0, 10.0D, d0));
